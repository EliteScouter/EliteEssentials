...
public class HytaleJoindateCommand extends AbstractPlayerCommand {
    ...
    public HytaleJoindateCommand(ConfigManager configManager, PlayerService playerService) {
        ...
        this.targetArg = withOptionalArg("player", "Player name to look up", ArgTypes.STRING);
    }
    ...
    protected void execute(@Nonnull CommandContext ctx, @Nonnull Store<EntityStore> store, @Nonnull Ref<EntityStore> ref,
        ...
        // No argument = check own join date
        ...
        // Looking up another player requires .others permission
